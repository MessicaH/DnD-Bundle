    ...
    return <>
        ...
        <div className='container'>
            ...
            <p>In Dungeons & Dragons, Races (origins) represent the various humanoid species that inhabit the fantasy worlds of the game.
                ...
                to more exotic options such as Dragonborn, Tieflings, and Gnomes. We will only be covering the nine core Races here per the 
                Player's Handbook.</p>
                ...
                <details>
                    ...
                    <div className='row abilityTable'>
                        <div className='column col-lg-6'>
                            ...
                            <ol>
                                <li><b>Charisma</b> (CHA) - Being able to flirt, lie, or love with anyone/thing</li>
        ...
        <div className='container card-deck charSection'>
            <div className="card text-center charCard">
                ...
                <div className='card-body'>
                    <p className='card-text'>Shaped by draconic gods or the dragons themselves, Dragonborn originally hatched from dragon eggs 
                        as a unique race, combining the best attributes of Dragons and humanoids.</p>
                    <h5 className='card-title'>Ability Bonuses</h5>
                    <p className='card-text'>+2 Strength (STR), +1 Charisma (CHA)
            ...
            <div className="card text-center charCard">
                ...
                <div className='card-body'>
                    <p className='card-text'>Dwarves are solid and enduring like the mountains they love, weathering the passage of centuries with stoic endurance 
                        and little change.</p>
                    <h5 className='card-title'>Ability Bonuses</h5>
                    <p className='card-text'>+2 Constitution (CON), Darkvision, Dwarven Resilience
            ...
            <div className="card text-center charCard">
                ...
                <div className='card-body'>
                    <p className='card-text'>Elves are a magical people of otherworldly grace, living in the world but not entirely part of it. They love 
                        nature, magic, art, music, poetry, and the good things of the world.</p>
                    <h5 className='card-title'>Ability Bonuses</h5>
                    <p className='card-text'>+2 on Dexterity (DEX) rolls, Darkvision
            ...
            <div className="card text-center charCard">
                ...
                <div className='card-body'>
                    <p className='card-text'>A constant hum of busy activity pervades the warrens and neighborhoods where Gnomes form their 
                    ...
                    <h5 className='card-title'>Ability Bonuses</h5>
                    <p className='card-text'>+2 Intelligence (INT), Darkvision
                    <br/>Gnome Cunning</p>
            ...
            <div className="card text-center charCard">
                ...
                <div className='card-body'>
                    <p className='card-text'>Walking in two worlds but truly belonging to neither, Half-Elves combine what some say are the best qualities 
                    ...
                    <h5 className='card-title'>Ability Bonuses</h5>
                    <p className='card-text'>+2 Charisma (CHA), +1 to two (2) other Ability Scores, Darkvision
            ...
            <div className="card text-center charCard">
                ...
                <div className='card-body'>
                    <p className='card-text'>The comforts of home are the goals of most Halflings’ lives: a place to settle in peace and quiet, far from marauding 
                        monsters and clashing armies; a blazing fire and a generous meal; fine drink and conversation. </p>
                    <h5 className='card-title'>Ability Bonuses</h5>
                    <p className='card-text'>+2 Dexterity (DEX), Lucky, Brave
            ...
            <div className="card text-center charCard">
                ...
                <div className='card-body'>
                    <p className='card-text'>Whether united under the leadership of a mighty warlock or having fought to a standstill after years of conflict, 
                        Orc and Human communities sometimes form alliances. When these alliances are sealed by marriages, Half-Orcs are 
                        born.</p>
                    <h5 className='card-title'>Ability Bonuses</h5>
                    <p className='card-text'>+2 Strength (STR), +1 Constitution (CON), Darkvision
            ...
            <div className="card text-center charCard">
                ...
                <div className='card-body'>
                    <p className='card-text'>In the reckonings of most worlds, Humans are the youngest of the common races, late to arrive on the world scene and 
                    ...
                    <h5 className='card-title'>Ability Bonuses</h5>
                    <p className='card-text'>+1 to all Ability Scores
                    <br/>Extra Language</p>
            ...
            <div className="card text-center charCard">
                ...
                <div className='card-body'>
                    <p className='card-text'>To be greeted with stares and whispers, to suffer violence and insult on the street, to see mistrust and fear in 
                    ...
                    <h5 className='card-title'>Ability Bonuses</h5>
                    <p className='card-text'>+2 Charisma (CHA), +1 Intelligence (INT), Darkvision
